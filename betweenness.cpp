...
//void Betweenness::betweenness_centrality_given_adj_matrix_and_source(std::vector<Rb_tree> & adj_matrix, unsigned long int source) {
...
//    std::vector<Rb_tree> adj_matrix = G.get_adj_matrix();
